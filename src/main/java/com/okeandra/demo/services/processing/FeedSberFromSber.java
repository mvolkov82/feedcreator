...
//    }
    ...
    public List<String> start() {
        ...
        try {
            isXlsDownloaded = ftp.downloadFileFromFtp(xlsSourceFtpFolder, xlsSourceFile,false);
        ...
        try {
            isSberItemsDownloaded = ftp.downloadFileFromFtp(ftpSberDirectory, sberItemsFile,false);
